...
BALL = pygame.transform.scale(BALL,(90,30))
...
def MainMenu(): #Makes the main menu
    ProjMotion = False
    Running = True
    Title = Font.render("Main Menu", 1, BLUE ) #'Main menu' title #Change to title later on
    ...
    while Running: #Main game loop that runs the animation
        DISPLAYSURF.fill(RED) #Initialises the screen by making it white
